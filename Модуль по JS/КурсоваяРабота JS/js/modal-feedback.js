export default class Modal {
  ...
  onDocumentClick(event) {
    ...
    if (targetButton && targetButton.dataset.modalButton === 'feedback') {
    ...
    const targetClose = event.target.closest("[data-modal__feedback-close]");
  ...
  open() {
    ...
    this.modal.classList.add("modal__feedback--open");
    this.modalWindow.classList.add("modal-feedback__window--open");
  ...
  close() {
    this.modal.classList.remove("modal__feedback--open");
    this.modalWindow.classList.remove("modal-feedback__window--open");
